...
public class RssController {
    ...
    public ResponseEntity<String> getRssFeed() {
        try {
            ...
            if (articles == null || articles.isEmpty()) {
                return ResponseEntity.ok(generateEmptyRss());
            }
    ...
    private String generateRss(List<ArticleDto> articles) {
        ...
        rss.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n")
                ...
                .append("    <description>Latest articles</description>\n")
        ...
        articles.forEach(article -> {
            ...
            if (article.getImageUrl() != null) {
                rss.append("      <enclosure url=\"").append(article.getImageUrl()).append("\" type=\"image/jpeg\"/>\n");
            }
